...
Application::Application(int& argc, char** argv)
    ...
    , m_instance(false)
{
    if (QDBusConnection::sessionBus().registerService("com.long.FileManager")) {
        setOrganizationName("longos");
        ...
        // Translations
        QLocale locale;
        QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/long-filemanager/translations/").arg(locale.name());
...
bool Application::parseCommandLineArgs()
{
    ...
    if (m_instance) {
        ...
        QDBusInterface iface("com.long.FileManager",
                             "/FileManager",
                             "com.long.FileManager",
