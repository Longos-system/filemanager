...
Item {
    ...
    Rectangle {
        ...
        height: _iconItem.height + _label.paintedHeight + LongUI.Units.largeSpacing
        x: (parent.width - width) / 2
        y: _iconItem.y

        // (Deprecated) Rectangle rounded corner.
        //color: selected || hovered ? LongUI.Theme.highlightColor : "transparent"
        color: "transparent"
    ...
    Item {
        ...
        width: parent.width - LongUI.Units.largeSpacing * 2
    ...
    Label {
        ...
        width: parent.width - LongUI.Units.largeSpacing * 2 - LongUI.Units.smallSpacing
        textFormat: Text.PlainText
        elide: Qt.ElideRight
        wrapMode: Text.Wrap
        text: control.fileName
        color: control.GridView.view.isDesktopView ? "white"
                                                   : selected ? LongUI.Theme.highlightColor
    ...
    Rectangle {
        z: 1
        x: _label.x + (_label.width - _label.paintedWidth) / 2 - (LongUI.Units.smallSpacing / 2)
        y: _label.y
        width: _label.paintedWidth + LongUI.Units.smallSpacing
    ...
    DropShadow {
        ...
        horizontalOffset: 1
        verticalOffset: 1
        radius: Math.round(4 * LongUI.Units.devicePixelRatio)
        samples: radius * 2 + 1
        spread: 0.35
