...
Item {
    ...
    property color hoveredColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.backgroundColor, 2.3)
                                                       : Qt.darker(LongUI.Theme.backgroundColor, 1.05)
    property color selectedColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.backgroundColor, 1.2)
                                                        : Qt.darker(LongUI.Theme.backgroundColor, 1.15)
//    onSelectedChanged: {
//        if (selected && !blank) {
...
//    }
    ...
    Rectangle {
        ...
        color: selected ? LongUI.Theme.highlightColor : hovered ? hoveredColor : "transparent"
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Label {
                id: _label2
                text: model.fileSize
                color: selected ? LongUI.Theme.highlightColor : LongUI.Theme.disabledTextColor
                textFormat: Text.PlainText
                Layout.fillWidth: true
                opacity: model.isHidden ? 0.8 : 1.0
            }
